...
type GameRecord struct {
	...
	// 关联
	WinTypes []*GameRecordWinType `gorm:"-" json:"win_types,omitempty"`
}
...
func (gp *GameRecord) CalculatePoints() {
	multi := 1
...
func (gp *GameRecord) SyncWinTypesRaw() error {
...
func (gp *GameRecord) LoadWinTypesFromRaw() error {
	if gp.WinTypesRaw == "" {
		gp.WinTypes = nil
		return nil
	}

	var winTypes []*GameRecordWinType
...
// GameRecordWinType 对局记录番型信息
type GameRecordWinType struct {
